...
public class RedisUtil {
	...
	private RedisUtil() {
		if (pool == null) {
			...
			pool = new JedisPool(config, ip, port, 100000, pwd);
		}
	}
	...
	public static void main(String[] args) throws Exception {
		 getRu().set("qwe", "呵呵呵呵"); 
		 System.out.println(getRu().get("qwe"));

		/*Jedis jedis = new Jedis("121.40.206.173", 30000);
		jedis.auth("0Zo04O5ovq2t5Ac81Y3AE8%ki");
		jedis.
		System.out.println("Server is running: " + jedis.ping());
		jedis.set("qwe", "哈哈哈哈哈哈");
		System.out.println(jedis.get("qwe"));*/
		
		// String mima =
		// AESUtils.encrypt("Jk78s@ad^K*J90%sdf!JIH9%dsf1@92(>?)39",
		// "djv9fld7dmvz6qel");
		// System.out.println(mima);

		// ZvqhZtuAc#1Y/N4AE8%kikUrKctECkz/&XyDwYOd4/pQObRkvdu(i<21;'S?dt637aR
	}
